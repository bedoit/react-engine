...
exports.create = function create(createOptions) {
  ...
  return function render(thing, options, callback) {
    ...
    function renderAndDecorate(component, data, html) {
      ...
      // var configureStore = createOptions.configureStore;
      // var store = configureStore(data.initialState);
      // var _Provider = React.createElement(Provider, {store: store}, component);
      ...
      var _html = createOptions.renderFullPage(html, script)
    ...
    if (createOptions.routes && createOptions.routesFilePath) {
      ...
      // Switch off this function becouse error comes
      // TODO fix it for later good usages

      // Error: Cannot find module '/public/routes.jsx' at Function.Module._resolveFilename (module.js:339:15) at Function.Module._load (module.js:290:25) at Module.require (module.js:367:17) at require (internal/module.js:16:19) at ReactEngineView.render (/home/anton/Envs/popwb/node_modules/react-engine/lib/server.js:142:30) at ReactEngineView.render (/home/anton/Envs/popwb/node_modules/react-engine/lib/expressView.js:56:10) at tryRender (/home/anton/Envs/popwb/node_modules/express/lib/application.js:639:10) at EventEmitter.render (/home/anton/Envs/popwb/node_modules/express/lib/application.js:591:3) at ServerResponse.render (/home/anton/Envs/popwb/node_modules/express/lib/response.js:961:7) at renderWith (webpack:///./server.js?:149:9)
    ...
    var data = merge({
      __meta: {
        ...
        // initState: options.initState //save initial store data
      }
      ...
      if (this.useRouter) {
        return match({ routes:createOptions.routes, location:thing}, function reactRouterMatchHandler(error, redirectLocation, renderProps) {
          if (error) {
            ...
            var appComponent = createOptions.appComponent;
            var appElement = React.createElement(appComponent, {
              renderProps: renderProps,
              data: data
            });

            return done(null, renderAndDecorate(appElement, data, html))
        ...
        // var view_provider = options.wrapComponent(view);
